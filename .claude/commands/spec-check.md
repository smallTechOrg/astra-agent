...
Use the `drift-auditor` subagent to run the workflow defined in [`spec/engineering/workflows/spec-check.md`](../../spec/engineering/workflows/spec-check.md). Return its report verbatim.
