...
class GroqClient(LLMClient):
    """Groq Cloud LLM client using the OpenAI-compatible API."""
    ...
    def __init__(
        ...
        self._model = model
        self._log = logger.bind(provider="groq", model=model)
    ...
    async def generate_content(
        ...
        *,
        ...
        self._log.debug(
            "groq.generate_content.complete",
    ...
    async def generate_structured(
        ...
        *,
        ...
        self._log.debug(
            "groq.generate_structured.complete",
            raw_len=len(raw),
            usage=response.usage.model_dump() if response.usage else None,
        )
